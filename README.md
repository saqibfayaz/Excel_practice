This is my first excel full project where i have used a raw data file, cleaned it, added columns by using functions to make data more understandable and usable for further examination. 
